package com.demo.rabbitmq.api.consumer;
...
public class ConfigureRabbitMq {
  ...
  public static final String EXCHANGE_NAME = "RABBIT_EXCHANGE_TOPIC";
  ...
  Binding binding(Queue q, TopicExchange exchange){
    return BindingBuilder.bind(q).to(exchange).with("rabbit.#");
  }
